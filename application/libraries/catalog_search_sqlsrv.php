	...
	function _search_count($limit=15, $offset=0)
	{
		...
		if ($variable!==FALSE)
		{
			...
			*/
			...
			$query_count.=" GROUP BY id,refno,surveyid,titl,nation,authenty, f.model,link_report,link_indicator, link_questionnaire, link_technical, link_study,proddate, isshared, repositoryid,varcount \r\n";
