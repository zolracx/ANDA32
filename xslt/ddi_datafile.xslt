...
-->		
	...
	<table border="1" style="border-collapse:collapse;" cellpadding="4" class="table-variable-list" width="100%">
		<tr class="var-th">
		<!-- do not display the variable id <td><xsl:call-template name="gettext"><xsl:with-param name="msg">ID</xsl:with-param></xsl:call-template></td> -->
...
<xsl:template match="ddi:var">
    ...
    <tr valign="top" class="{$class}" id="{$id}" title="{$hover}">			
        <!-- do not display the variable id <td class="var-td"><a href="{$link}" ><xsl:value-of select="@ID"/></a></td> --><!--  - <xsl:value-of select="position()"/>-->
