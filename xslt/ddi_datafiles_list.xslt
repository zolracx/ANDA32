...
<xsl:template match="/">	
    ...
    <div class="xsl-title"><xsl:call-template name="gettext"><xsl:with-param name="msg">data_files</xsl:with-param></xsl:call-template></div>
    <table  cellpadding="4" class="ddi-table" width="100%">	
	<tr>
		<th><xsl:call-template name="gettext"><xsl:with-param name="msg">ID</xsl:with-param></xsl:call-template></th>
		...
		<th><xsl:call-template name="gettext"><xsl:with-param name="msg">Type</xsl:with-param></xsl:call-template></th>
